...
class Ui_Segreteria_Home(object):
    def setupUi(self, Segreteria_Home):
        ...
        Segreteria_Home.resize(846, 413)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Segreteria_Home):
        ...
        self.DateDiposnibiliEsami.setText(_translate("Segreteria_Home", "Fornisci allo studente le date degli esami disponibili per l\'esame scelto dallo studente"))
        self.InserimentoEsamiButton.setText(_translate("Segreteria_Home", "Inserisci gli esami sul server dell\'università "))
        self.InoltraRichiestaButton.setText(_translate("Segreteria_Home", "Inoltra la richiesta di prenotazione degli studenti al server universitario"))
        self.InserimentoLaureaButton.setText(_translate("Segreteria_Home", "Insersci Laurea sul server dell\'università"))
